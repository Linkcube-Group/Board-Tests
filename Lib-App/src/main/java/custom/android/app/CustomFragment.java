...
public class CustomFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        Timber.d(((Object) this).getClass().getName() + " onAttach");
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        Timber.d(((Object) this).getClass().getName() + " onCreateView");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Timber.d(((Object) this).getClass().getName() + " onViewCreated");
    }

    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        Timber.d(((Object) this).getClass().getName() + " onActivityCreated");
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        Timber.d(((Object) this).getClass().getName() + " onDestroyView");
    }
