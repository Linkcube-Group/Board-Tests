...
import custom.android.app.R.string;

/**
 * Dialog with a date picker. Implement
...
public class DatePickerDialogFragment extends BaseDialogFragment {
	...
	protected BaseDialogFragment.Builder build(
		...
		mDatePicker = (DatePicker) LayoutInflater.from(getActivity()).inflate(
				R.layout.dialog_part_datepicker, null);
	...
	public static class SimpleDialogBuilder extends
		...
		protected SimpleDialogBuilder(Context context,
				FragmentManager fragmentManager,
				Class<? extends DatePickerDialogFragment> clazz) {
